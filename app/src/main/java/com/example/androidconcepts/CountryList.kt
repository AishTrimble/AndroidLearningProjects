...
class CountryList : AppCompatActivity() {
            ...
            client.newCall(request).enqueue(object : Callback {
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    runOnUiThread {
                        ...
                        displayList.clear()
                        displayList.addAll(parsedData.map { "${it.value} (${it.key})" }) // Format: "Country Name (ISO)"

                        adapter.notifyDataSetChanged() // Refresh ListView without creating a new adapter
                    }
                }
    ...
    fun parseCountryListXml(xmlResponse: String): HashMap<String, String> {
        ...
        try {
            ...
            for ((iso, name) in countryMap) {
                Log.d("CountryMap", "ISO: $iso, Name: $name")
            }
        } catch (e: Exception) {
